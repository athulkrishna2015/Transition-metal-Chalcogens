            ...
            # if j0 != j1:
                for n0 in range(1,l):
                    for n1 in range(1,l):
                        if n0+n1 ==l:
                            # if n0 != 2:
                            print(f'{val5[i]}2{chal[j0]}{n0}{chal[j1]}{n1}')
                            # else :
                    ...
                    for n1 in range(1,l):
                        for n2 in range(1,l):                
                            # if (j0 != j1) and (j0 != j2) and (j1 != j2):
                                if n0+n1+n2 == l:
                                    print(f'{val5[i]}2{chal[j0]}{n0}{chal[j1]}{n1}{chal[j2]}{n2}')
#M2XYZA
for i in range(len(val5)):
    for j0 in range(len(chal)):
        for j1 in range(j0+1, len(chal)):
                            ...
                            for n2 in range(1,l):
                                for n3 in range(1,l):
                                    # if (j0 != j1) and (j0 != j2) and (j0 != j3) and (j1 != j2) and (j1 != j3) and (j2 != j3):
                                        if n0+n1+n2+n3 == l:
                                            print(f'{val5[i]}2{chal[j0]}{n0}{chal[j1]}{n1}{chal[j2]}{n2}{chal[j3]}{n3}')
