            ...
            # if j0 != j1:
                for n0 in range(1,l):
                    for n1 in range(1,l):
                        if n0+n1 ==l:
                            # if n0 == 2:
                            #     print(f'{val7[i]}{chal[j0]}{n0}{chal[j1]}4')
                            # elif n1 == 2:
                            #     print(f'{val7[i]}{chal[j0]}2{n0}{chal[j1]}') 
                            # else:
                            print(f'{val7[i]}2{chal[j0]}{n0}{chal[j1]}{n1}')
                            # else :
                    ...
                    for n1 in range(1,l):
                        for n2 in range(1,l):                
                            # if (j0 != j1) and (j0 != j2) and (j1 != j2):
                                if n0+n1+n2 == l:
                                    # if n0 == 2:
                                    #     print(f'{val7[i]}{chal[j0]}{chal[j1]}{chal[j2]}')
                                    # else:
                                    print(f'{val7[i]}2{chal[j0]}{n0}{chal[j1]}{n1}{chal[j2]}{n2}')
#M2XYZA
for i in range(len(val7)):
    for j0 in range(len(chal)):
        for j1 in range(j0+1, len(chal)):
